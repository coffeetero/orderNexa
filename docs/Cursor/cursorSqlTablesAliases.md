# SQL Table Alias Standards

Use this file as the default alias reference when writing SQL in this repo.

## Rules

- Keep aliases consistent across all new SQL scripts and migrations.
- When adding a new table alias, append it here before using it.
- If an alias is defined here, do not invent an alternate alias for the same table.
